...
System.out.println("prices for oranges: $" + price);
...
for(int oddcounter = 1; oddcounter<=100; oddcounter=oddcounter+2)
...
for(int threecounter = 3; threecounter<=100; threecounter=threecounter+3)
System.out.print(threecounter + "-");

System.out.println();

    //Starting at 1000, print on the same line (with a - [hypthen] between each) all of the numbers that end in 0 going down to 0
for(int counter = 1000; counter>=0; counter=counter-100)
